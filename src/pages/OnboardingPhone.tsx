...
export default function OnboardingPhone() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate to next step (e.g., OTP or email)
      navigate("/onboarding/email"); // adjust if your flow is different
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Welcome to Miramore</h1>
        <p className="text-sm text-gray-400 mb-8">Enter your phone number to get started</p>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-6">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm text-gray-400">Remember me for faster sign‑in</span>
          </label>
